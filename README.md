...
| Android | APK dari [latest release](../../releases/latest) — `family-app-tracking-arm64.apk` (19 MB) untuk hampir semua HP sekarang, atau `family-app-tracking-arm32.apk` (16,6 MB) untuk HP lama |
